...
/* if visited is true then dont animate loading page just unlock body*/
const menuBtn = document.getElementById('menu-btn');

let closed = true;

/*visited = sessionStorage.getItem('colibritech') || false;
  console.log(visited);
...
if(visited != "true"){
	...
	sessionStorage.setItem('colibritech', "true")
}
*/
